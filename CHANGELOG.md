...
= 8.0.0.1 =
=======
- Maven **`au.gov.nehta:mhr-b2b-client`** **8.0.0.1** (Java **8** / **`javax`**, **15** facades). The first number of the Maven version is the targeted Java SE version. Pair with **`au.gov.nehta:mhr-wsdl`** at the same coordinate.
