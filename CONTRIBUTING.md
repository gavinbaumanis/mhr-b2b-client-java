...
The **first number** of **`au.gov.nehta:mhr-b2b-client`** is the **Java SE** version that this client targets. **8.0.0.1** is **`javax`** with **15** facades; **11.0.0.1** and later are **Jakarta** with **15** facades. See **`README.md`**.
...
Install matching **`common-library`** and **`mhr-wsdl`** first (same Java line: **`8.0.0.1-SNAPSHOT`**):
